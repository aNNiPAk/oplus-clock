...
Канал исходного stock APK `com.coloros.alarmclock` для Obtainium.
...
Daily schedule включён. Для ручной проверки: Actions → Update OPlus clock → Run workflow → оставить `dry_run: true`. Для публикации отключить `dry_run`.
