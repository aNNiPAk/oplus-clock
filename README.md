...
Unmodified stock APK for `com.coloros.alarmclock`, extracted from the original OPlus firmware.

## Updates

The updater checks the official OTA source daily. To check manually, open Actions → Update OPlus clock → Run workflow. Leave `dry_run` enabled to verify without publishing; disable it to publish a newer verified version.
